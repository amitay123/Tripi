    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Icon(Icons.check_circle, size: 100, color: TripiColors.primary),
            ...
            Text(
              ...
              style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: TripiColors.onSurfaceVariant),
            ),
