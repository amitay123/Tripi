  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: TripiColors.background,
        elevation: 0,
        title: Text('Select Seat', style: Theme.of(context).textTheme.headlineSmall),
      ),
      body: Column(
        children: [
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  const Text('CABIN FRONT', style: TextStyle(letterSpacing: 2, color: TripiColors.onSurfaceVariant, fontSize: 12)),
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text('Selected Seat', style: Theme.of(context).textTheme.bodyLarge),
                    Text(
                      _tempSeat ?? 'None',
                      style: Theme.of(context).textTheme.headlineSmall?.copyWith(color: TripiColors.primary, fontWeight: FontWeight.bold),
                    ),
                  ],
                ),
                ...
                ElevatedButton(
                  onPressed: _tempSeat == null
                      ? null
                      : () {
                          context.read<BookingProvider>().selectSeat(_tempSeat!);
